...
import fr.adneom.arrayslicer.utils.impl.AdneomArrayUtils;
...
@SpringBootTest
public class AdneomArrayUtilsTest {

	@Autowired
    AdneomArrayUtils adneomArrayUtils;
	...
	public void testPartitionArray_nominalTest01() {
        ...
        // run
        List<List<Integer>> output = adneomArrayUtils.partition(input, 2);
        // verify
    ...
    public void testPartitionArray_nominalTest02() {
        ...
        List<Integer> input = Arrays.asList(1, 2, 3, 4, 5);
        // run
        List<List<Integer>> output = adneomArrayUtils.partition(input, 3);
        // verify
        assertThat(output, is(notNullValue()));
	...
	public void testPartitionArray_nominalTest03() {
        ...
        List<Integer> input = Arrays.asList(1, 2, 3, 4, 5);
        // run
        List<List<Integer>> output = adneomArrayUtils.partition(input, 1);
        // verify
        assertThat(output, is(notNullValue()));
    ...
    public void testPartitionArray_shouldReturnNull_whenInputListIsEmpty() {
        ...
        // run
        List<String> output = adneomArrayUtils.partition(input, 2);
        // verify
    ...
    public void testPartitionArray_shouldReturnOneChild_whenInputSizeHigherThanListSize() {
        ...
        // run
        List<List<Integer>> output = adneomArrayUtils.partition(input, 10);
        // verify
        assertThat(output, is(notNullValue()));
        assertThat(output.size(), is(3));
    }
